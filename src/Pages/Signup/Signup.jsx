  ...
  return (
    <div className="min-h-screen bg-[#fad4d4] flex justify-center items-center p-8">
      ...
      <motion.div
        ...
        className="bg-white shadow-lg rounded-lg w-full max-w-lg p-4 flex flex-col"
      >
        ...
        <form className="space-y-4">
          ...
          >
            ...
            <input
              className="w-full px-4 py-4 bg-gray-50 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"
              type="text"
              id="name"
